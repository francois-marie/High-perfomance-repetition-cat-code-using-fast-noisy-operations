...
def global_setup(columns='twocolumn', paper='a4paper', fontsize=11):
    plt.rcdefaults()
    # plt.rcParams.update(
    #     {
    #         'text.usetex': True,
    ...
    plt.style.use(
        ['seaborn-white', f'{qsim_repo_path}/tools/quantum-plots.mplstyle']
    )
    ...
    plt.rcParams['legend.fontsize'] = fontsizes['scriptsize']
